...
public class AlchemyAPI_CombinedParams extends AlchemyAPI_Params {
	...
	public void setSourceText(String sourceText) {
		if (!sourceText.equals(AlchemyAPI_CombinedParams.CLEANED)
				&& !sourceText.equals(AlchemyAPI_CombinedParams.CLEANED_OR_RAW)
				&& !sourceText.equals(AlchemyAPI_CombinedParams.RAW)
				&& !sourceText.equals(AlchemyAPI_CombinedParams.CQUERY)
	...
	public void setExtractMode(String extractMode) {
		if (!extractMode.equals(EXTRACT_MODE_TRUST)
				&& !extractMode.equals(EXTRACT_MODE_INFER)) {
			throw new RuntimeException("Invalid setting " + extractMode
					+ " for parameter extractMode");
		}
	...
	public void setExtract(String extractArg) {
		if (!extractArg.equals(EXTRACT_PAGE_IMAGE)
			...
			throw new RuntimeException("Invalid setting " + extractArg
					+ " for parameter extract");
		}
	...
	public String getParameterString() {
		...
		try {
			if (extractMode != null)
				retString += "&extractMode=" + extractMode;
			if (extract != null)
				retString += "&extract=" + extract;
			if (sentiment != null)
