...
public class AlchemyAPI_ConceptParams extends AlchemyAPI_Params {
	...
	public void setSourceText(String sourceText) {
		if (!sourceText.equals(AlchemyAPI_ConceptParams.CLEANED)
				&& !sourceText.equals(AlchemyAPI_ConceptParams.CLEANED_OR_RAW)
				&& !sourceText.equals(AlchemyAPI_ConceptParams.RAW)
				&& !sourceText.equals(AlchemyAPI_ConceptParams.CQUERY)
