package me.thesis.preferencepairs.alchemy;
...
public class AlchemyAPI {
	...
	public Document URLGetAuthor(String url) throws IOException, SAXException,
	...
	public Document HTMLGetAuthor(String html, String url) throws IOException,
	...
	public Document URLGetRankedNamedEntities(String url) throws IOException,
			SAXException, ParserConfigurationException,
			XPathExpressionException {
		return URLGetRankedNamedEntities(url,
				new AlchemyAPI_NamedEntityParams());
	}

	public Document URLGetRankedNamedEntities(String url,
			AlchemyAPI_NamedEntityParams params) throws IOException,
			SAXException, ParserConfigurationException,
			XPathExpressionException {
		CheckURL(url);
	...
	public Document HTMLGetRankedNamedEntities(String html, String url)
			throws IOException, SAXException, ParserConfigurationException,
			XPathExpressionException {
		return HTMLGetRankedNamedEntities(html, url,
				new AlchemyAPI_NamedEntityParams());
	}
	...
	public Document TextGetRankedNamedEntities(String text) throws IOException,
			SAXException, ParserConfigurationException,
			XPathExpressionException {
		return TextGetRankedNamedEntities(text,
				new AlchemyAPI_NamedEntityParams());
	}
	...
	public Document URLGetRankedConcepts(String url) throws IOException,
			SAXException, ParserConfigurationException,
			XPathExpressionException {
	...
	public Document TextGetRankedConcepts(String text) throws IOException,
			SAXException, ParserConfigurationException,
			XPathExpressionException {
		return TextGetRankedConcepts(text, new AlchemyAPI_ConceptParams());
	}

	public Document TextGetRankedConcepts(String text,
			AlchemyAPI_ConceptParams params) throws IOException, SAXException,
			ParserConfigurationException, XPathExpressionException {
		CheckText(text);
	...
	public Document TextGetRankedKeywords(String text,
			AlchemyAPI_KeywordParams params) throws IOException, SAXException,
			ParserConfigurationException, XPathExpressionException {
		CheckText(text);
	...
	public Document HTMLGetText(String html, String url,
			AlchemyAPI_TextParams params) throws IOException, SAXException,
			ParserConfigurationException, XPathExpressionException {
		CheckHTML(html, url);
	...
	public Document URLGetConstraintQuery(String url, String query)
		...
		return URLGetConstraintQuery(url, query,
				new AlchemyAPI_ConstraintQueryParams());
	}
	...
	public Document HTMLGetConstraintQuery(String html, String url, String query)
			throws IOException, XPathExpressionException, SAXException,
			ParserConfigurationException {
		return HTMLGetConstraintQuery(html, url, query,
				new AlchemyAPI_ConstraintQueryParams());
	}

	public Document HTMLGetConstraintQuery(String html, String url,
			String query, AlchemyAPI_ConstraintQueryParams params)
			throws IOException, XPathExpressionException, SAXException,
			ParserConfigurationException {
		CheckHTML(html, url);
		if (null == query || query.length() < 2)
	...
	public Document URLGetTextSentiment(String url) throws IOException,
			SAXException, ParserConfigurationException,
			XPathExpressionException {
	...
	public Document TextGetTextSentiment(String text) throws IOException,
			SAXException, ParserConfigurationException,
			XPathExpressionException {
	...
	public Document URLGetTargetedSentiment(String url, String target,
			AlchemyAPI_TargetedSentimentParams params) throws IOException,
			SAXException, ParserConfigurationException,
			XPathExpressionException {
		CheckURL(url);
		CheckText(target);
	...
	public Document HTMLGetTargetedSentiment(String html, String url,
			String target) throws IOException, SAXException,
			ParserConfigurationException, XPathExpressionException {
	...
	public Document HTMLGetTargetedSentiment(String html, String url,
			String target, AlchemyAPI_TargetedSentimentParams params)
			throws IOException, SAXException, ParserConfigurationException,
			XPathExpressionException {
		CheckHTML(html, url);
		CheckText(target);
	...
	public Document URLGetRelations(String url) throws IOException,
			SAXException, ParserConfigurationException,
			XPathExpressionException {
	...
	public Document HTMLGetRelations(String html, String url,
			AlchemyAPI_RelationParams params) throws IOException, SAXException,
			ParserConfigurationException, XPathExpressionException {
		CheckHTML(html, url);
	...
	public Document TextGetRelations(String text) throws IOException,
			SAXException, ParserConfigurationException,
			XPathExpressionException {
	...
	public Document URLGetCombined(String url) throws IOException,
			SAXException, ParserConfigurationException,
			XPathExpressionException {
	...
	public Document TextGetCombined(String text) throws IOException,
			SAXException, ParserConfigurationException,
			XPathExpressionException {
		AlchemyAPI_CombinedParams params = new AlchemyAPI_CombinedParams();
		params.setExtractAll();
	...
	public Document TextGetCombined(String text,
			AlchemyAPI_CombinedParams params) throws IOException, SAXException,
			ParserConfigurationException, XPathExpressionException {
		CheckText(text);
	...
	public Document URLGetTaxonomy(String url) throws IOException,
			SAXException, ParserConfigurationException,
			XPathExpressionException {
	...
	public Document HTMLGetTaxonomy(String html, String url,
			AlchemyAPI_TaxonomyParams params) throws IOException, SAXException,
			ParserConfigurationException, XPathExpressionException {
		CheckHTML(html, url);
	...
	public Document TextGetTaxonomy(String text) throws IOException,
			SAXException, ParserConfigurationException,
			XPathExpressionException {
	...
	public Document URLGetRankedImageKeywords(String url) throws IOException,
			SAXException, ParserConfigurationException,
			XPathExpressionException {
		return URLGetRankedImageKeywords(url, new AlchemyAPI_ImageParams());
	}

	public Document URLGetRankedImageKeywords(String url,
			AlchemyAPI_ImageParams params) throws IOException, SAXException,
			ParserConfigurationException, XPathExpressionException {
		CheckURL(url);
	...
	public Document ImageGetRankedImageKeywords(AlchemyAPI_ImageParams params)
		...
		handle.addRequestProperty("Content-Length",
				Integer.toString(image.length));

		DataOutputStream ostream = new DataOutputStream(
				handle.getOutputStream());
		ostream.write(image);
		ostream.close();
	...
	private Document GET(String callName, String callPrefix,
			AlchemyAPI_Params params) throws IOException, SAXException,
			ParserConfigurationException, XPathExpressionException {
	...
	private Document POST(String callName, String callPrefix,
			AlchemyAPI_Params params) throws IOException, SAXException,
			ParserConfigurationException, XPathExpressionException {
	...
	private Document doRequest(HttpURLConnection handle, String outputMode)
		...
		if (AlchemyAPI_Params.OUTPUT_XML.equals(outputMode)) {
			String statusStr = getNodeValue(factory, doc,
					"/results/status/text()");
			if (null == statusStr || !statusStr.equals("OK")) {
				...
				if (null != statusInfoStr && statusInfoStr.length() > 0)
					throw new IOException("Error making API call: "
							+ statusInfoStr + '.');
			...
			String statusStr = getNodeValue(factory, doc,
					"//RDF/Description/ResultStatus/text()");
			if (null == statusStr || !statusStr.equals("OK")) {
				String statusInfoStr = getNodeValue(factory, doc,
						"//RDF/Description/ResultStatus/text()");
				if (null != statusInfoStr && statusInfoStr.length() > 0)
